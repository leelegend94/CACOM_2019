...
"""load the model"""
fhr_out_model = xgb.Booster({'nthread':4}) # init model
fhr_out_model.load_model('fhr_out_model') # load model data

"""load the data: TODO!!!!!!!!!!"""
# should return a data set called data!!
# please take load_all_data function in fhr_out.py as a reference to load the new test data!!
...
label_pred = fhr_out_model.predict(dtest)
